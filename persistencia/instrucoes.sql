...
CREATE TABLE produto(
    ...
    CONSTRAINT fk_prod_fornecedor FOREIGN KEY(forn_id) REFERENCES fornecedor(forn_id)
);
...
CREATE TABLE venda(
    ...
    CONSTRAINT fk_vend_clientId FOREIGN KEY(vend_clienteId) REFERENCES cliente(cli_id)
);
